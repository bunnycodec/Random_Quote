function getQuote() {
  ...
  var authors = ["― Kurt Vonnegut Jr.", "― Paulo Coelho", "― Walt Disney Company, Mulan", "― Maya Angelou", "― Saul Bellow", "― Maya Angelou", "― Edgar Allan Poe", "― Lance Armstrong", "― Kalu Ndukwe Kalu", "― Vincent van Gogh", "― J.K. Rowling, Harry Potter and the Goblet of Fire", "― Jane Goodall", "–The Goblet of Fire", " –The Order of the Phoenix", "–The Half-Blood Prince", "― Harry Potter and the Sorcerer’s Stone", "―  Harry Potter and the Sorcerer’s Stone", "– Harry Potter and the Prisoner of Azkaban", "― Marcus Aurelius, Meditations", "― Dalai Lama XIV", "– Lionel Messi"];
  ...
  document.querySelector('.randomQuote').textContent = ranQuote
  document.querySelector('.author').textContent = ranAuthor

}

document.querySelector('.next-quote').addEventListener('click', () => getQuote())

// For Page Opening Quote
getQuote()